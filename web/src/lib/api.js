...
export const analyticsAPI = {
  ...
  getRevenueSummary: () =>
    api.get("/api/analytics/revenue/summary").then((res) => res.data),
  ...
  getRevenueByProfessional: (startDate = null, endDate = null) =>
    api
      .get("/api/analytics/revenue/by-professional", {
        params: {
...
export const vendorsAPI = {
  getAll: (params) =>
    api.get("/api/vendors", { params }).then((res) => res.data),
  getById: (id) => api.get(`/api/vendors/${id}`).then((res) => res.data),
  getMyProfile: () =>
    api.get("/api/vendors/me/profile").then((res) => res.data),
  setupProfile: (data) =>
    api.post("/api/vendors/me/profile", data).then((res) => res.data),
  updateProfile: (data) =>
    api.put("/api/vendors/me/profile", data).then((res) => res.data),
  uploadAvatar: (formData) => {
    return api
      .post("/api/vendors/me/avatar", formData, {
...
export const professionalsAPI = {
  // Vendor endpoints
  inviteProfessional: (data) =>
    api.post("/api/professionals/invite", data).then((res) => res.data),
  getMyTeam: () =>
    api.get("/api/professionals/me/team").then((res) => res.data),
  updateProfessional: (id, data) =>
    api
      .put(`/api/professionals/${id}/vendor-update`, data)
      .then((res) => res.data),
  deleteProfessional: (id) =>
    api.delete(`/api/professionals/${id}`).then((res) => res.data),

  // Professional endpoints
  getMyProfile: () => api.get("/api/professionals/me").then((res) => res.data),
  updateMyProfile: (data) =>
    api.put("/api/professionals/me", data).then((res) => res.data),

  // Public endpoints
  getVendorProfessionals: (vendorId) =>
  ...
  // Invite acceptance
  acceptInvite: (data) =>
    api.post("/api/professionals/accept-invite", data).then((res) => res.data),
};

// ========== SERVICES ==========
export const servicesAPI = {
  getVendorServices: (vendorId) =>
    api.get(`/api/services/vendor/${vendorId}`).then((res) => res.data),
  ...
  uploadImage: (serviceId, file) => {
    ...
    return api
      .post(`/api/services/${serviceId}/images`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      })
      .then((res) => res.data);
  },
  deleteImage: (imageId) =>
    api.delete(`/api/services/images/${imageId}`).then((res) => res.data),
};

// ========== AVAILABILITY ==========
export const availabilityAPI = {
  getMySchedule: () =>
    api.get("/api/availability/schedule/me").then((res) => res.data),
  getProfessionalSchedule: (professionalId) =>
    api
      .get(`/api/availability/schedule/professional/${professionalId}`)
      .then((res) => res.data),
  updateScheduleDay: (scheduleId, data) =>
    api
      .put(`/api/availability/schedule/${scheduleId}`, data)
      .then((res) => res.data),

  getMyBlockers: () =>
    api.get("/api/availability/blockers/me").then((res) => res.data),
  getProfessionalBlockers: (professionalId) =>
    api
      .get(`/api/availability/blockers/professional/${professionalId}`)
      .then((res) => res.data),
  createBlocker: (data) =>
    api.post("/api/availability/blockers", data).then((res) => res.data),
...
export const bookingsAPI = {
  ...
  getCustomerBookings: () =>
    api.get("/api/bookings/me/customer").then((res) => res.data),
  getProfessionalBookings: () =>
    api.get("/api/bookings/me/professional").then((res) => res.data),
  ...
  markNoShow: (id) =>
    api.post(`/api/bookings/${id}/no-show`).then((res) => res.data),

  // Calendar endpoints (NEW)
  getMyCalendar: (params) =>
    api.get("/api/bookings/calendar/me", { params }).then((res) => res.data),
  getVendorCalendar: (params) =>
    api
      .get("/api/bookings/calendar/vendor", { params })
      .then((res) => res.data),
};
...
export const reviewsAPI = {
  ...
  getVendorReviews: (vendorId) =>
    api.get(`/api/reviews/vendor/${vendorId}`).then((res) => res.data),
  getProfessionalSummary: (professionalId) =>
    api
      .get(`/api/reviews/professional/${professionalId}/summary`)
      .then((res) => res.data),
  getVendorSummary: (vendorId) =>
    api.get(`/api/reviews/vendor/${vendorId}/summary`).then((res) => res.data),
  getMyReviews: () => api.get("/api/reviews/my").then((res) => res.data),
  getBookingReview: (bookingId) =>
    api.get(`/api/reviews/booking/${bookingId}`).then((res) => res.data),
};
